...
public class Main {
    public static void main(String[] args) {
        ...
        Aluno aluno = new Aluno("Samuell Aguiar", "Rua Luiz Ferreira, 63", "31982089884", "15086106656", "2128025",
                curso);
        disciplina.add(aluno);

        Aluno aluno2 = new Aluno("Gustavo Rolim", "Rua Luiz Ferreira, 63", "31982089884", "15086106656", "2128025",
                curso);
        disciplina.add(aluno2);
        Professor professor = new Professor("Gilda", "Rua B, 456", "987654321", "10987654321", "12345678901", 5000.0,
                "Doutorado", "Engenharia de Software");
        TecnicoAdministrativo tecnico = new TecnicoAdministrativo("José", "Rua C, 789", "456789123", "21098765432",
                "12345678901", 2500.0);
